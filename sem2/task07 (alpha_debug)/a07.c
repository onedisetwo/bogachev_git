...
int main(int argc, char *argv[]){
	const int TASK = 7, MIN_ARGC = 7, MAX_ARGC = 9;
	const char *VAR_LIST = "t m n p kA (nameA) kX0 (nameX0)";

	int m, n, p, kA, kX0;
	char *nameA, *nameX0;
	int  arg, retA, retX0;
	double *a, *x0, *x1, *b, *r, *x_m, t, time, r1, r2;
	...
	time = clock();
	x_m = solve7(a, b, x0, x1, r, n, m, t);
	time = (clock() - time) / CLOCKS_PER_SEC;
	printf("Vector x_m:\n");
	print_matrix(x_m, 1, n, p);
	init_b(a, b, n);
	r1 = get_r1_task2_10(a, x_m, b, n);
	r2 = get_r2_task2_10(x_m, n);
